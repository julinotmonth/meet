            ...
            <div className='wadah_poster_about'>
                <Row>
                    <Col xl={8} lg={8} md={8} sm={6} xs={6}>
                        <span className='about_us_postere'>ENDORSEMENT</span>
                    </Col>
                    ...
                    <Col xl={4} lg={4} md={4} sm={6} xs={6} className='column_border_left'>
                        <div className='wadah_content_poster'>
                            ...
                            <span className='home_testimoni_poster'>Home | Testimoni</span>
                        </div>
                    </Col>
                </Row>
            </div>
...
export default PosterEndorsement;